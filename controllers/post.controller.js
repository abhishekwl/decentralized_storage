...
exports.getAllPublicPosts = (request, response) => Post.find({}, (err, data) => respond(err, data, request, response));

exports.getAllPublicVideos = (request, response) => Post.find({ category: 'VIDEO' }, (err, data) => respond(err, data, request, response));

exports.getAllPublicImages = (request, response) => Post.find({ category: 'IMAGE' }, (err, data) => respond(err, data, request, response));
